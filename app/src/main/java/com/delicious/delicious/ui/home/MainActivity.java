package com.delicious.delicious.ui.home;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Global.getRequestService().getSearch("사당맛집",1)
                ...
                .subscribe(new Action1<SearchChannel>() {
                    @Override
                    public void call(SearchChannel searchChannel) {
                        Log.v(TAG,searchChannel.getChannel().getItem().get(0).getImage());
                    }
